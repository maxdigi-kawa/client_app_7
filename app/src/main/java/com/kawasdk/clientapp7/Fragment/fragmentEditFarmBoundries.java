...
//                    }
    ...
    private void initButtons() {
        ...
        genrateReportBtn = VIEW.findViewById(R.id.genrateReportBtn);
    ...
    private void hideAllBtn() {
        ...
        genrateReportBtn.setVisibility(VIEW.GONE);
        addMoreBtn.setVisibility(View.GONE);
...
//            LNGLAT.add(ll);
            ...
            if (KawaMap.isFormEnable) {
                ...
                STRSUBMIT = String.valueOf(FILEDSOBJECT);
...
//                rowAreaTextView.setPadding(150, 0, 0, 0);
                rowAreaTextView.setText(POLYGONAREA.get(i).toString());
